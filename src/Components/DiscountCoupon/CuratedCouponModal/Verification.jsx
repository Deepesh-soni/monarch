    ...
    <Wrapper>
      <CouponDetails>
        <FlexBox column>
          ...
          <Body1>{discountType == 1 ? "Flat Rate" : "Percentage"}</Body1>
        </FlexBox>
        <FlexBox column>
        ...
        <FlexBox column>
          ...
          <Body1>
            {dayjs(couponData?.endDate).format("DD MMMM, YYYY HH:mm A")}
          </Body1>
        </FlexBox>
      </CouponDetails>
      ...
      <Button
        ...
        onClick={!otpSent ? handleSendOtp : createCuratedCoupons}
